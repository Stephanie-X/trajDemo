...
import java.awt.*;
import com.geomesa.storing.utils.*;
...
//    }
    ...
    public static void main(String[] args) {
       // getDistanceInKM(115.99,39.69,116.00,39.69);
        double x = getDistanceInKM(115.99,39.69,116.00,39.69);
        double y = getDistanceInKM(115.99,39.69,115.99,39.70);
        System.out.println(x);
        System.out.println(y);
        System.out.println(x*y);
        System.out.println("***************");
        double radLat1 = Math.toRadians(39.69);
...
//        return 2 * Math.asin(Math.sqrt(Math.pow(Math.sin(radLatDistance / 2), 2) + Math.cos(radLat1) * Math.cos(radLat2) * Math.pow(Math.sin(radLngDistance / 2), 2))) * EARTH_RADIUS_IN_METER;
      ...
      //  System.out.println(getDistanceInKM(115.99,39.69,115.99,39.69));

       // Point point = new Point(115.99465,39.69923);
    }
